...
import { Home, User, Code, Briefcase, MessageSquare, Mail, BookOpen, Sun, Moon, Github, Linkedin, Globe } from "lucide-react";
                        ...
                        {navItems.map((item) => (
                            <a
                                ...
                                className={cn(
                                    ...
                                    activeSection === item.href ? "bg-primary text-white" : "text-gray-600 hover:text-primary dark:text-gray-300 dark:hover:text-primary"
                                )}
