...
export const HeroSection = () => {
    ...
    const codeSnippets = [
        "import { MERN-Stack-Developer } from 'Mohammad Rashel';",
        "",
        "const developer = new MERN-Stack-Developer({",
        "  name: 'Mohammad Rashel',",
    ...
    const handleViewResume = () => {
        ...
        window.open("/Mohammad-Rashel-resume-2025.pdf", "_blank", "noopener,noreferrer");
    };
            ...
            <div className="container max-w-7xl mx-auto w-full mt-16 sm:mt-0">
                ...
                >
                    <div className="flex-1 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
                        ...
                        >
                            <span className="block text-foreground">I&apos;m Mohammad Rashel</span>
                            <motion.span
                        ...
                        >
                            I build <span className="text-primary font-semibold">high-performance web applications</span> Junior MERN Stack Developer with experience building full-stack applications
                            using React, Node, Express, and MongoDB. Skilled in responsive UIs, REST APIs, JWT authentication, and deploying apps on Vercel/Netlify. Passionate about clean code and
                            contributing to impactful team projects
                        </motion.p>
                        ...
                        <div className="relative w-full max-w-md">
                            ...
                            ${
                                line.includes("import")
                                    ...
                                    : line.includes("React") || line.includes("Node.js") || line.includes("TypeScript")
                                    ? "text-cyan-400"
                          ...
                          `}
                                                >
                                                    ...
                                                    {index === currentCodeLine ? (
                                                        <>
                                                            {displayedCode}
                                                            <motion.span animate={{ opacity: [1, 0, 1] }} transition={{ duration: 0.8, repeat: Infinity }} className="ml-1 text-primary inline-block">
                                                                ▊
                                                            </motion.span>
                                                        </>
                                                    ) : (
