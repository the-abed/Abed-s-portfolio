...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/mohammad-rashel/", label: "LinkedIn" },
    { icon: <Instagram size={18} />, href: "#", label: "Instagram" },
    { icon: <Youtube size={18} />, href: "#", label: "YouTube" },
    { icon: <Github size={18} />, href: "https://github.com/rashel-dev", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "mrashel.dev@gmail.com", href: "mrashel.dev@gmail.com" },
    { icon: <Phone size={16} />, text: "+88 01851588329", href: "tel:01851588329" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Mohammad Rashel</h3>
          ...
          >
            <div>
              <p>© {currentYear} Mohammad Rashel. All rights reserved.</p>
            </div>
