...
const projects = [
  {
    ...
    highlights: [
      ...
      "Book your desired pet or accessories easily.",
      "See you orders.",
  ...
  },
  {
    ...
    description:
      "SkillSwap is an interactive platform for individuals to offer, learn, and trade skills within their local area. Whether it’s Quran learning, language exchange, coding help, or fitness training — users can browse listings, rate experiences, and connect with local skill providers.This platform aims to foster community learning, skill-sharing, and local networking in a seamless and user-friendly way.",
    ...
    highlights: [
      ...
      "Book your desired skill easily.",
  ...
  },
  {
    ...
    demoUrl: "https://hero-io-b1208.netlify.app/",
...
const categoryColors = {
  ...
  "Travel Management":
    "from-sky-500/20 to-blue-600/20 text-sky-600 border-sky-500/30",
  "Technology & Programming":
    "from-slate-500/20 to-gray-600/20 text-slate-600 border-slate-500/30",
  "App management":
    "from-pink-500/20 to-rose-600/20 text-pink-600 border-pink-500/30",
};
...
export const ProjectsSection = () => {
  ...
  return (
    <section
      id="projects"
      className="relative min-h-screen py-20 md:py-20 overflow-hidden bg-gradient-to-br from-background via-background to-primary/5"
      ref={sectionRef}
    >
      {/* Clean Background */}
