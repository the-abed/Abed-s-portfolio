...
const skills = [
  ...
  { name: "Next.js", level: 60, category: "frontend", icon: "nextjs" },
...
export const SkillsSection = () => {
  ...
  return (
    <section id="skills" className="py-20 px-4 bg-gradient-to-br from-background via-secondary/5 to-background">
