...
const WelcomeScreen = ({ onWelcomeComplete }) => {
    ...
    const portfolioUrl = "https://mohammad-rashel-portfolio.vercel.app/";
                    ...
                    <motion.div className="space-y-4 md:space-y-8">
                        ...
                        {phase >= 1 && (
                            ...
                            >
                                ...
                                <motion.span className="inline-block ml-2 sm:ml-3 relative" style={{ color: currentColors.secondary }} variants={contentVariants}>
                                    There !
                                    <motion.span
